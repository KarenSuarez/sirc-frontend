...
export class ListaComponent implements OnInit {
  ...
  crearReferido() {
    this.router.navigate(['/referidos/crear']);
  }
  ...
  contactarReferido(referido: Referido) {
    this.modal.confirm({
      nzTitle: '¿Contactar referido?',
      nzContent: `¿Deseas marcar como contactado a ${referido.nombre}?`,
      nzOkText: 'Sí, contactar',
      nzCancelText: 'Cancelar',
      nzOnOk: () => {
        referido.estado = 'contactado';
        referido.fechaContacto = new Date();
        this.message.success('Referido marcado como contactado');
      }
    });
  }
